...
SECRET_KEY = 'tw4wle2*hp)ibuh)n!yxd&pm$3o8-j8qss-)^^7eh_^y=k-n6@'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'app_file_handler': {
             ...
             'filename':  os.path.join(STATIC_ROOT,'app.log'),
             'formatter':'standard'
        }, # 用于文件输出
        'sys_file_handler': {
             'level': 'DEBUG',
             'class': 'logging.handlers.TimedRotatingFileHandler',
             'filename':  os.path.join(STATIC_ROOT,'sys.log'),
             'formatter':'standard'
        }, # 用于文件输出
        'console':{
            'level': 'INFO',
    ...
    'loggers': {
        'django': {
            'handlers' :['sys_file_handler', 'console'],
            'level':'DEBUG',
